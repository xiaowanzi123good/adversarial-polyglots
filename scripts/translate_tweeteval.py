...
data['test'].map(translate_add_columns, fn_kwargs={'translators': translators}).save_to_disk(
    'data/tweeteval_sentiment_translated_test')

data['validation'].map(translate_add_columns, fn_kwargs={'translators': translators}).save_to_disk(
    'data/tweeteval_sentiment_translated_validation')
