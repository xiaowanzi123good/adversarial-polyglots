...
def main():
    ...
    elif data_args.task_name is None and not is_regression and isinstance(label_list[0], str):
    ...
    def preprocess_function(examples):
        ...
        if label_to_id is not None and "label" in examples and isinstance(examples["label"][0], str):
